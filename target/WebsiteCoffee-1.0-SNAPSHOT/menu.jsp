        ...
        <table class="warp-table">
          ...
          <tbody>
            ...
            %>
                ...
                <td><%= product.getProductVariants()%></td>
                <td>Nóng hoặc Lạnh</td>
                <td><%= product.getBasePrice() %></td>
                <td><span class="status-badge status-in"><%= product.getStatus()%></span></td>
                <td>
      ...
      <div class="modal-dialog modal-dialog-centered modal-confirm">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="confirmationModalLabel">Delete item?</h5>
